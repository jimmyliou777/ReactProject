...
class App extends Component {
  ...
  render() {
    ...
    <div id="btn" onClick={this.handleClick}>
     ...
     <div className="block a"><h4>RWD</h4><img className="icon" src="https://hahow.in/assets/images/logo.svg" alt="" /></div>
     <div id="leftMenu" className={liClasses} ref="leftMenu"  style={{height:0}}>
