	...
	render() {
      ...
      <MuiThemeProvider>
       <AppNav
          ...
          onTodoAdd={height =>
            this.props.actions.addClass(height)
          }
          onTodoRemove={height =>
            this.props.actions.removeClass(height)
          }
           />   
      </MuiThemeProvider>
      <div id="leftMenu" className={liClasses} ref="leftMenu"  style={{height:this.props.height}}>
